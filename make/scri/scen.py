	...
	for a in range(variDict["charCoun"]):
		...
		if char:
			...
			if upda:
				...
				loca, orientat, pathPoly = path.Path(loca, orientat, obje["pathPoly"], moveVect, variDict["inpuMagn"], 0.0, 0.0, True, False, False, False, scen, math, mathutils, Math, pathObje, debu = True)
