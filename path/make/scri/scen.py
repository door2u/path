	...
	for a in range(variDict["charCoun"]):
		...
		if char:
			...
			if upda:
				...
				loca, orientat, pathPoly = path.Path(obje.worldPosition, obje.orientation, obje["pathPoly"], moveVect, variDict["inpuMagn"], spee, offs, False, True, False, False, scen, math, mathutils, Math)
				# place the object vertically on the surface of the path
				loca, orientat, pathPoly = path.Path(loca, orientat, pathPoly, moveVect, variDict["inpuMagn"], 0.0, 0.0, True, False, False, False, scen, math, mathutils, Math)
